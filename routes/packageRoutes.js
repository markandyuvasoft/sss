...
router.post('/create', protect(['event-manager', 'event-agency', 'independent', 'volunteer']), packageController.createPackage);
...
router.put('/:packageId', protect(['event-manager', 'event-agency', 'independent', 'volunteer']), packageController.updatePackage);
