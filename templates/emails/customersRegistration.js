// templates/emails/customerRegistration.js
module.exports = (fullName, email, registrationLink) => {
  return `
  <html>
  <head>
    <meta charset="UTF-8">
    <title>Welcome to Gopratle, ${fullName}!</title>
    <style>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <p>Welcome to Gopratle! We're excited to help you plan your next amazing event.</p>
        <p>Your registration details:</p>
        <div class="details">
          <ul>
            <li><b>Email:</b> ${email}</li>
            <li><b>Role:</b> Customer</li>
            <li><b>Purpose:</b> Plan</li>
          </ul>
        </div>
        <p>Log in to <a href="${registrationLink}" style="color:#FF4C18; text-decoration:none;"><b>gopratle.com</b></a> to explore event planning tools, connect with event managers, and bring your vision to life!</p>
      </div>
      <div class="cta">
        <a href="${registrationLink}">Start Planning</a>
      </div>
      <div class="footer">
        <p>Happy planning!<br/>Gopratle </p>
      </div>
    </div>
  </body>
  </html>
