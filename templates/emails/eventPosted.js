module.exports = (fullName, eventName, eventType, location, guests, startDate, endDate, budget, currency, additionalInfo, eventLink) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 10px; padding: 20px; background-color: #f9f9f9;">
    <div style="text-align: center;">
      <h2 style="color: #FF4C18;"> Your Event is Live! Let’s Celebrate! </h2>
      <p style="font-size: 16px; color: #333;">Hey <strong>${fullName}</strong>, your event "<strong>${eventName}</strong>" is now live! </p>
    </div>
    ...
    <div style="margin-top: 15px; text-align: center;">
      <p style="font-size: 16px;"> We’re notifying event managers so you receive the best proposals soon!</p>
      <p style="font-size: 14px; color: #555;">(Keep an eye on your inbox for updates!)</p>
    </div>
